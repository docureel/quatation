...
function renderQuotation(data) {
    ...
    document.getElementById('out_gear').innerText = data.gearDetails || "Not Specified";
...
async function editHistoryItem(docId) {
    try {
        ...
        if(doc.exists) {
            ...
            // Gear Details Edit Data
            document.getElementById('c_gear').value = item.gearDetails && item.gearDetails !== 'N/A' ? item.gearDetails : '';
